...
apply_i3wm() {
	...
	sed -i ${PATH_I3WM}/config.d/01_theme.conf \
		...
		\
		-e "s/set \$i3_cl_col_bg.*/set \$i3_cl_col_bg $foreground/g" \
		-e "s/set \$i3_cl_col_fg.*/set \$i3_cl_col_fg $background/g" \
		-e "s/set \$i3_cl_col_in.*/set \$i3_cl_col_in $color2/g" \
		-e "s/set \$i3_cl_col_afoc.*/set \$i3_cl_col_afoc $element_hl/g" \
	...
	sed -i ${PATH_I3WM}/i3status/statusbar.conf \
		...
		-e "s/set \$i3_bar_foc.*/set \$i3_bar_foc $element_hl/g" \
		-e "s/set \$i3_bar_act.*/set \$i3_bar_act $color4/g" \
		-e "s/set \$i3_bar_ina.*/set \$i3_bar_ina $background/g" \
